...
import { Package, PlusSquare } from "lucide-react";
import { FaHome, FaBars, FaChevronLeft, FaChevronRight } from "react-icons/fa";
...
const SellerDashboard = () => {
  ...
  const menuItems = [
    { to: "/dashboard/seller-products", icon: <Package size={18} />, label: "My Products" },
    { to: "/dashboard/add-product", icon: <PlusSquare size={18} />, label: "Add Product" },
        ...
        >
          <div className="flex items-center justify-between p-6 border-b border-amber-700">
            <div className={`flex flex-col items-center md:items-start ${isSidebarOpen ? "" : "hidden md:flex"}`}>
              <h1 className="text-2xl font-bold raleway">Seller Panel</h1>
